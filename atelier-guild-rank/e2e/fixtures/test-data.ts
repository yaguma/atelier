...
export const TOOLTIP_TEST_DATA = {
  ...
  maxWidth: 300,
  /** テスト対象要素のセレクター */
  testElements: ['.card-element', '.quest-card', '.material-slot', '.item-icon'],
} as const;
...
export const CARD_TEST_DATA = {
  /** テスト用カードID */
  testCardIds: ['card-001', 'card-002', 'card-003'],
  /** ドラッグ可能なカードのセレクター */
...
export const QUEST_TEST_DATA = {
  /** テスト用依頼ID */
  testQuestIds: ['quest-001', 'quest-002', 'quest-003'],
  /** 依頼難易度 */
  difficulties: [1, 5, 10],
  /** 依頼報酬範囲 */
  rewardRange: {
