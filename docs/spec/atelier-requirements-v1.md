...
> このドキュメントはv1.4（Unity/EARS版）であり、参考資料として保持されています。
...
- **REQ-024-1**: システムは各ターン開始時にエネルギーを3提供しなければならない 🔵 *ユーザーヒアリング2025-12-20より確定*
- **REQ-024-2**: システムはエネルギーの最大値を10に設定しなければならない 🔵 *ユーザーヒアリング2025-12-20より確定*
- **REQ-024-3**: 各カードは0〜5のコストを持たなければならない 🔵 *ユーザーヒアリング2025-12-20より確定*
- **REQ-025**: システムはカードの合成・進化システムを実装しなければならない 🔵 *ユーザヒアリング質問6-2より*
- **REQ-026**: システムはデッキ枚数に制限を設けてはならない 🔵 *ユーザヒアリング質問5-3より*
- **REQ-026-1**: システムは初期手札枚数を5枚に設定しなければならない 🔵 *ユーザーヒアリング2025-12-20より確定*
- **REQ-026-2**: システムは毎ターン開始時に手札が5枚になるようドローしなければならない 🔵 *ユーザーヒアリング2025-12-20より確定*
...
- **REQ-041-1**: システムはアセンション難易度を最大10レベルまで実装しなければならない 🔵 *ユーザーヒアリング2025-12-20より確定（20→10に変更）*
...
| 2025-12-20 | 1.4 | ユーザーヒアリングに基づく要件確定: REQ-024-1〜3(エネルギー)、REQ-026-1〜2(手札)を🔴→🔵に更新、REQ-041-1(アセンション最大レベル)を20→10に変更し🔵に更新 |
