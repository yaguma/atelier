...
- **REQ-020**: システムは火の錬金術師、水の錬金術師、毒の錬金術師、鉱の錬金術師、精霊錬金術師の5スタイルを提供しなければならない 🟡 *README.md 錬金スタイル表 + ユーザヒアリング質問10-1から推測(将来実装)*
...
- **REQ-028**: デッキ構築によって手札枚数が変動する場合、システムはその枚数を計算して反映しなければならない 🔵 *ユーザヒアリング質問6-3より*
...
- **REQ-031**: システムは依頼の難易度を星の数等で明確に表示しなければならない 🔵 *ユーザヒアリング質問7-2より*
- **REQ-032**: システムは20〜30種類の顧客タイプを提供しなければならない 🔵 *ユーザヒアリング質問7-5より*

#### 条件付き要件

- **REQ-033**: 安定値が閾値を下回った場合、システムは暴発を発生させなければならない 🔵 *ユーザヒアリング質問7-4より*
