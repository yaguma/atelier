...
トースト通知（一時的なメッセージ表示）を管理するToastManagerを設計・実装する。
...
**実装ファイル**: `src/presentation/phaser/managers/ToastManager.ts`
...
1. `/tsumiki:tdd-requirements TASK-0180` - 詳細要件定義
