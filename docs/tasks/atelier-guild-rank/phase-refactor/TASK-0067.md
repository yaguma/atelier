...
- [ ] BaseComponentがsrc/shared/components/に移動されている
- [ ] テーマ定義がsrc/shared/theme/に移動されている
- [ ] @shared/componentsパスエイリアスでインポートできる
- [ ] @shared/themeパスエイリアスでインポートできる
- [ ] 共通コンポーネントのテストが全てパスする
- [ ] UIの見た目・動作に変化がない
- [ ] 全テストがパスする
